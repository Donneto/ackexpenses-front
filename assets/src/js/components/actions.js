  ...
  return(
    <div className="box ">
      <div className="buttons is-centered ">
        <button className="button is-danger is-outlined is-small is-rounded"><span className="icon"><i className="mdi mdi-minus-box mdi-18px"/></span> <span><b>Expense</b></span></button>
